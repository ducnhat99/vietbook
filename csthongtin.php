...
<html>
                        ...
                        if(isset($_POST['ts']) and isset($_POST['sl']) and isset($_POST['id']) and isset($_POST['gia']))
	{
                    ...
                    echo '
                <h1 style="margin-left: 350px;margin-top: 20px; color: #f46523">THÔNG TIN CÁ NHÂN</h1>
                <form method="POST" style="margin-left: 280px; width: 500px; margin-top: 30px">
                    <fieldset style="height:400px;"> 
                    <h4>Tên người dùng</h4></br>
                    <input class="tx" type="text" id="snd" name="tndcs" value="'.$_SESSION['tnd'].'" placeholder="Tên người dùng" style="width:90%;height:30px;" disabled /></br></br>
                    <h4>Địa chỉ</h4></br>
                    <input class="tx" type="text" id="sdc" name="dccs" value="'.$_SESSION['dc'].'" placeholder="Địa chỉ" style="width:90%;height:30px;" disabled/></br></br>
                    <h4>Số điện thoại</h4></br>
                    <input class="tx" type="tell" id="sdt" name="sdtcs" value="'.$_SESSION['sdt'].'" placeholder="Số điện thoại" style="width:90%;height:30px;" disabled/></br></br>
                    <h4>Email</h4></br>
                    <input class="tx" type="email" id="sem" name="emcs" value="'.$_SESSION['em'].'" placeholder="Email" style="width:90%;height:30px;" disabled/></br></br>
