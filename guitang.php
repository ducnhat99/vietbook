...
<html>
                        ...
                        if(isset($_POST['ts']) and isset($_POST['sl']) and isset($_POST['id']) and isset($_POST['gia']))
	{
                    ...
                    echo '
                <h1 style="margin-left: 350px;margin-top: 20px; color: #f46523">THÔNG TIN NGƯỜI NHẬN</h1>
                <form method="POST" style="margin-left: 280px; width: 500px; margin-top: 30px">
                    <fieldset style="height:400px;"> 
                    <h4>Tên người nhận</h4></br>
                    <input class="tx" type="text" id="snd" name="tndcs" value="" placeholder="Tên người nhận" style="width:90%;height:30px;"  /></br></br>
                    <h4>Địa chỉ người nhận</h4></br>
                    <input class="tx" type="text" id="sdc" name="dccs" value="" placeholder="Địa chỉ người nhận" style="width:90%;height:30px;" /></br></br>
                    <h4>Số điện thoại người nhận</h4></br>
                    <input class="tx" type="tell" id="sdt" name="sdtcs" value="" placeholder="Số điện thoại người nhận" style="width:90%;height:30px;" /></br></br>
                    <h4>Email người nhận</h4></br>
                    <input class="tx" type="email" id="sem" name="emcs" value="" placeholder="Email người nhận" style="width:90%;height:30px;" /></br></br>
