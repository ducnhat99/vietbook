...
<html>
    ...
    <body>
        ...
        <div class="noidung">
            <div class="homepage" >
                  ...
                  <a href="dsdonhanght.php"><input style="width: 300px;
    height: 35px;
    background: #f46523;
    border:none;
    margin-top: 20px;
    ...
    <a href="dsdonhangkn.php"><input style="width: 300px;
    height: 35px;
    background: #f46523;
    border:none;
    margin-top: 20px;
    ...
    color: #FAFAFA;" type="button" value="Xem danh sách đơn hàng không nhận"></a>
                  <table class="dh" border='1' WIDTH='100%' style=" margin-top: 10px;"> 
                    ...
                    <TD style="color:darkgreen"><b><u>Gửi tặng</u></b></TD>
                    ...
                    <TD style="color:darkgreen"><b><u>Xem thêm</u></b></TD>
                    </tr>
