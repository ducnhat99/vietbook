...
if(isset($_SESSION['status']))
	...
	if(!empty($_POST['submit']))
	{
		...
		$msg=array();
		if(empty($_POST['tnsach']) || empty($_POST['ttg']) || empty($_POST['nxb']) || empty($_POST['gia']) )
		{
		...
		else
		{
			...
			$query="insert into sach(madm,manxb,tensach,tentacgia,namxb,gia,hinhanh,noibat)
			values('$mdmucc','$mnxban','$tensach','$tentg','$namxban','$giaa','$b_img','$noi')";
                        mysqli_set_charset($conn, 'UTF8');
